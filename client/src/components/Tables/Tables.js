                ...
                <tbody>
                  {
                    userdata.length > 0 ? userdata.map((element, index) => {
                      return (
                        ...
                        <hr />
                          <tr>
                            <td data-cell="ID">{index + 1 + (page - 1)*4}</td> 
                            <td data-cell="FullName">{element.fname + element.lname}</td>
                            <td data-cell="Email">{element.email}</td>
                            <td data-cell="Gender">{element.gender == "Male" ? "M" : "F"}</td>
                            <td className='d-flex align-items-center' data-cell="Status">
                              <Dropdown className='text-center'>
                                <Dropdown.Toggle className='dropdown_btn' id="dropdown-basic">
                                  <Badge bg={element.status == "Active" ? "warning" : "danger"}>
                            ...
                            <td className='img_parent' data-cell="Profile">
